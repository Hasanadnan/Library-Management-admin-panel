...
<section>
	<div class="log_img">
	 ...
	 <div class="box1">   
		...
		<h1 style="text-align: center; font-size: 25px; color: white">Admin Login From</h1>
	  ...
	  <p>
	  	...
	  	New to this website?<a style="color: white;" href="registration.php">&nbsp Sign Up</a>
	  </p>
      </form>
	 </div>	
	</div>
     ...
     <?php
       ...
       if (isset($_POST['submit'])) {
         ...
         if($count==0)
         {
          ...
          /*________________if username & password match_________*/
